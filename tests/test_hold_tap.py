...
class TestHoldTap(unittest.TestCase):
    def test_basic_kmk_keyboard(self):
        keyboard = KeyboardTest(
            [
                [KC.MT(KC.LCTL, KC.A), KC.LT(1, KC.B), KC.C, KC.D],
        ...
        keyboard.test(
            ...
            [(1, True), 100, (3, True), 50, (1, False), 50, (3, False)],
            [{KC.B}, {KC.B, KC.D}, {KC.D}, {}],
        )

        keyboard.test(
            'LT within tap time nested -> hold behavior',
            [(1, True), 100, (3, True), 50, (3, False), 50, (1, False)],
            [{KC.N4}, {}],
        )
